...
SafeAddString(NOTYOU_GROUPZONE_HEADER,					"Messages de zone de groupe", 1)
SafeAddString(NOTYOU_GROUPZONE,							"Options de bloquage :", 1)
SafeAddString(NOTYOU_GROUPZONE_TOOLTIP,				"Sélectionnez le type de redirection à effectuer lors d'une réception d'un message de zone de groupe :\n|cFFFFFFAucune|r - Pas de modifications\n|cFFFFFFChat|r - Messages redirigés dans le Chat\n|cFFFFFFSilencieux|r - Les messages sont complètement supprimés", 1)
...
SafeAddString(NOTYOU_CROWCRATES,							"Désactiver les caisses à couronnes", 1)
SafeAddString(NOTYOU_CROWCRATES_TOOLTIP,				"Masquer l'icône des caisses à couronnes et désactiver le raccourci clavier vers ce menu", 1)
...
SafeAddString(NOTYOU_WAYSHRINES,							"Oratoires sur la carte de Tamriel", 1)
SafeAddString(NOTYOU_WAYSHRINES_TOOLTIP,				"Sélectionnez le mode d'affichage des oratoires sur la carte de Tamriel", 1)

SafeAddString(NOTYOU_DUNGEONS,							"Donjons sur la carte de Tamriel", 1)
SafeAddString(NOTYOU_DUNGEONS_TOOLTIP,					"Sélectionnez le mode d'affichage des donjons découverts sur la carte de Tamriel", 1)

SafeAddString(NOTYOU_UNOWNED_HOUSES,					"Maisons non possédées", 1)
SafeAddString(NOTYOU_UNOWNED_HOUSES_TOOLTIP,			"Sélectionnez le mode d'affichage des maisons non possédées sur les cartes", 1)

SafeAddString(NOTYOU_OWNED_HOUSES,						"Maisons possédées", 1)
SafeAddString(NOTYOU_OWNED_HOUSES_TOOLTIP,			"Sélectionnez le mode d'affichage des maisons possédées sur les cartes", 1)

SafeAddString(NOTY_WAYSHRINE_OPTION_0,					"Afficher", 1)
SafeAddString(NOTY_WAYSHRINE_OPTION_1,					"Uniquement les capitales", 1)
SafeAddString(NOTY_WAYSHRINE_OPTION_2,					"Masquer", 1)

SafeAddString(NOTY_DUNGEONS_OPTION_0,					"Afficher", 1)
SafeAddString(NOTY_DUNGEONS_OPTION_1,					"Uniquement les épreuves", 1)
SafeAddString(NOTY_DUNGEONS_OPTION_2,					"Masquer", 1)

SafeAddString(NOTY_UNOWNED_HOUSES_OPTION_0,			"Afficher", 1)
SafeAddString(NOTY_UNOWNED_HOUSES_OPTION_1,			"Zones / Villes seulement", 1)
SafeAddString(NOTY_UNOWNED_HOUSES_OPTION_2,			"Masquer", 1)

SafeAddString(NOTYOU_NOUNOWNEDHOUSES,					"Ne pas afficher les maisons non possédées", 1)
SafeAddString(NOTYOU_NOUNOWNEDHOUSES_TOOLTIP,		"Ne pas afficher les maisons non possédées sur les cartes. Seules les maisons possédées seront affichées.", 1)

SafeAddString(NOTYOU_NOSHRINESTAMRIEL,					"Pas d'oratoires sur la carte de Tamriel", 1)
SafeAddString(NOTYOU_NOSHRINESTAMRIEL_TOOLTIP,		"Ne pas afficher les oratoires sur la carte de Tamriel. Ceux-ci seront affichés sur les cartes régionales.", 1)

SafeAddString(NOTYOU_ONLY_CAPITAL_PINS,				"Oratoires principaux sur la carte de Tamriel", 1)
SafeAddString(NOTYOU_ONLY_CAPITAL_PINS_TOOLTIP,		"Afficher uniquement les oratoires principaux sur la carte de Tamriel. Les autres seront affichés sur les cartes régionales.", 1)
...
SafeAddString(NOTYOU_NOLOREDISCOVERIES,				"Bloquer le message \"Livre découvert\"", 1)
SafeAddString(NOTYOU_NOLOREDISCOVERIES_TOOLTIP,		"Sélectionnez le type de redirection à effectuer lors d'une réception d'un message Livre découvert :\n|cFFFFFFAucune|r - Pas de modifications\n|cFFFFFFChat|r - Messages redirigés dans le Chat\n|cFFFFFFSilencieux|r - Les messages sont complètement supprimés", 1)

SafeAddString(NOTYOU_NOSKILLSPROGRESS,					"Bloquer le message \"Augmentation de Compétence au rang X\"", 1)
SafeAddString(NOTYOU_NOSKILLSPROGRESS_TOOLTIP,		"Sélectionnez le type de redirection à effectuer lors d'une réception d'un message de progression de compétence :\n|cFFFFFFAucune|r - Pas de modifications\n|cFFFFFFChat|r - Messages redirigés dans le Chat\n|cFFFFFFSilencieux|r - Les messages sont complètement supprimés", 1)

SafeAddString(NOTYOU_NOCRAFTBAG_NOTIF,					"Désactiver les notifications du sac d'artisanat", 1)
SafeAddString(NOTYOU_NOCRAFTBAG_NOTIF_TOOLTIP,		"Ne pas notifier que mes objets ont étés déplacés dans le sac d'artisanat à la connexion et au changement de zone", 1)
